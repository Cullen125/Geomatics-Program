    ...
    public partial class Form1 : Form
    {
        ...
        private void open_tool_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int i = 0;
                dataGridView1.RowCount = Datacenter.orbits.Count;

                foreach(var o in Datacenter.orbits)
                {
                    dataGridView1[0, i].Value = o.t.ToString("F0");
                    dataGridView1[1, i].Value = o.x.ToString("F3");
                    dataGridView1[2, i].Value = o.y.ToString("F3");
                    dataGridView1[3, i].Value = o.z.ToString("F3");
                    i++;
                }
                load_label.Text = "已导入";
