    ...
    public partial class Form1 : Form
    {
        ...
        private void open_tool_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int i = 0;
                dataGridView1.RowCount = Datacenter.times.Count;

                foreach (var t in Datacenter.times)
                {
                    dataGridView1[0, i].Value = t.year;
                    dataGridView1[1, i].Value = t.mon;
                    dataGridView1[2, i].Value = t.day;
                    dataGridView1[3, i].Value = t.hour;
                    dataGridView1[4, i].Value = t.min;
                    dataGridView1[5, i].Value = t.sec;
                    i++;
                }
            }
            catch (Exception)
